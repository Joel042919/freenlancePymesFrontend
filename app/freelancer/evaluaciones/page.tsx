  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-2xl font-extrabold text-brand-dark">Evaluación de habilidades</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          {skills.map((skill) => (
            <Card key={skill.skillId} className="rounded-3xl border-slate-100 shadow-sm">
